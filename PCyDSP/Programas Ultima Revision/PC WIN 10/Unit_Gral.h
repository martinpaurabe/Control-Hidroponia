...
__published:	// IDE-managed Components
  ...
  void __fastcall But_UpD_MtrClick(TObject *Sender);
	...
	void __fastcall Show_Mod10_TROnKeyPress(TObject *Sender, System::WideChar &Key);
	void __fastcall Show_Mod11_TROnKeyPress(TObject *Sender, System::WideChar &Key);
	void __fastcall Show_Mod12_TROnKeyPress(TObject *Sender, System::WideChar &Key);
